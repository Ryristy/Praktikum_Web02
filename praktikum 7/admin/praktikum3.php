...
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="custom-control custom-checkbox custom-control-inline">
        <input name="skills" id="skills_3" type="checkbox" class="custom-control-input" value="PHP"> 
        <label for="skills_3" class="custom-control-label">PHP</label>
      </div>
      <div class="custom-control custom-checkbox custom-control-inline">
        <input name="skills" id="skills_4" type="checkbox" class="custom-control-input" value="Python"> 
